...
const VerticalFeatures = () => (
  <div id="vertical-features">
    ...
    >
      ...
      <VerticalFeatureRow
        title="ИИ агенты"
        description="ИИ агенты позволяют автоматизировать рутинные задачи, такие как обработка заявок, ответы на часто задаваемые, быстро искать документы в базе компании."
